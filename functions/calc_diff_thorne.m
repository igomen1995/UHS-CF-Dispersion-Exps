function [D12CE_cm2min,dD12CE_cm2min,D12TE_cm2min,dD12TE_cm2min] = ...
...
[DCE_p,DTE_p] = calc_D_local(sigma1_p,sigma2,eps1,eps2,...
    MW1,MW2,rhoNmix,rhoN1,rhoN2,T,NA);
[DCE_m,DTE_m] = calc_D_local(sigma1_m,sigma2,eps1,eps2,...
    MW1,MW2,rhoNmix,rhoN1,rhoN2,T,NA);
...
[DCE_p,DTE_p] = calc_D_local(sigma1,sigma2_p,eps1,eps2,...
    MW1,MW2,rhoNmix,rhoN1,rhoN2,T,NA);
[DCE_m,DTE_m] = calc_D_local(sigma1,sigma2_m,eps1,eps2,...
    MW1,MW2,rhoNmix,rhoN1,rhoN2,T,NA);
...
function [D12CE,D12TE] = calc_D_local(...
