...
opts.VariableNames = ["Key", "Date", "Type","Fluid1", "Fluid2", ...
    ...
    "setupVersion", "Vlinesbefore", "Vlinesafter", "Vtotal", "Comments", "workingPump", "cushionPump", "confiningPump", "st", "et", "dt", ...
...
opts.VariableTypes = ["string", "string","string", "string", "string", ...
    ...
    "string", "double", "double", "double","string", "double","double","double","datetime", "datetime", "double", ...
