...
opts.VariableTypes = ["string", "string","string","string", "double", "string", "double", "string", "double", "double",  "datetime", "datetime", "double", "string", "string", "string", "string", "string", "string", "string"];
